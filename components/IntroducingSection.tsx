    ...
    <div className="py-20 pt-24 bg-gradient-to-l from-white to-primary">
      <div className="text-center flex flex-col gap-y-5 items-center">
        ...
        <div>
          ...
          <Link href="/shop" className="bg-transparent border-2 border-secondary block text-secondary  font-bold px-12 py-3 text-xl hover:bg-gray-100 w-96 mt-2  max-md:text-lg max-md:w-72 max-[480px]:w-60 mx-auto">
            SHOP NOW
          </Link>
        </div>
      </div>
